...
# Shared schema application entrypoint.
# Callers are responsible for preparing a reachable DATABASE_URL first; this
# script only applies db/schema/*.sql and records versions in schema_migrations.
